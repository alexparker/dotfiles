let g:airline#themes#alex_airline#palette = {}

" Color palette
let s:cterm_termbg    = 231  " Background for branch and file format blocks
let s:gui_termbg      = '#5F5F5F'
let s:cterm_termfg    = 237  " Foreground for branch and file format blocks
let s:gui_termfg      = '#AFAF87'

let s:cterm_termbg2   = 255  " Background for middle block
let s:gui_termbg2     = '#1C1C1C'
let s:cterm_termfg2   = 237   " Foreground for middle block
...
let g:airline#themes#alex_airline#palette.visual = airline#themes#generate_color_map(s:V1, s:BB, s:V2)
let g:airline#themes#alex_airline#palette.visual_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#alex_airline#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
